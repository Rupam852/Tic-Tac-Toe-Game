              ...
              <div className="space-y-8 max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-5 space-y-6">
                    ...
                    {/* Android App Sideload Sourced Download Banner inside menu (Website Only) */}
                    {!isNative && (
                      <div className="rounded-2xl bg-blue-500/5 border border-blue-900/30 p-5 text-center flex flex-col items-center justify-center space-y-3">
                        <span className="text-[10px] font-bold tracking-wider text-slate-550 dark:text-slate-400 uppercase">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group flex items-center justify-center gap-2 px-5 py-2.5 w-full rounded-xl text-[11px] font-black uppercase tracking-widest text-slate-700 dark:text-slate-200 bg-slate-100 hover:bg-slate-200 dark:bg-slate-950 dark:border dark:border-slate-850 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-xs cursor-pointer"
                        >
                          <Download className="h-3.5 w-3.5 text-blue-500 dark:text-blue-400 group-hover:translate-y-0.5 transition-transform" />
                          Download APK
                        </a>
                      </div>
                    )}
